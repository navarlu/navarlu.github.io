export const placeholderEmail = "your.email@example.com";
...
export const projects = [
  ...
  },
  {
    ...
    href: "https://navarlu.github.io/voice-agent/",
    linkLabel: "Try Demo",
    external: true
  },
  {
    title: "InfantNet Automatic Touch Detection",
    description: "ML project for automatic detection of infant touch events from video frames.",
    category: "AI",
    tags: ["Machine Learning", "Detection", "Python"],
    image: "images/infant_net.png",
    href: "https://github.com/navarlu/InfantTouchNet",
    external: true
  },
  {
    title: "TinyTouch Labeling Application",
    description: "Desktop app for coding and labeling self-touch events in video data.",
    category: "Tools",
    tags: ["Python", "Labeling", "Data"],
    image: "images/tiny_touch.png",
    href: "https://github.com/ctu-vras/touch-coder",
    external: true
  },
  {
